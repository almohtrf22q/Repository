      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl border border-slate-200 transform animate-in zoom-in-95 duration-200">
        ...
        <div className="bg-gradient-to-r from-[#0F2C59] to-[#153B75] p-5 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-black font-cairo">من نحن - المحترف للسفريات والسياحة</h3>
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="bg-amber-50/60 p-4 rounded-xl border border-amber-200/60 leading-relaxed font-tajawal text-slate-800 text-sm sm:text-base font-bold">
            مكتب <span className="text-[#0F2C59] font-black">المحترف للسفريات والسياحة</span> هي وجهتكم الأولى والأكثر موثوقية لتنظيم كافة رحلات السفر، واستخراج التأشيرات، وحجوزات الطيران والفنادق، وخدمات المعتمرين وحجاج بيت الله الحرام بأعلى معايير الدقة والسرعة.
          </div>
